...
def template_model(symvar_type='SX'):
    ...
    # Preassure parameters
    KB   = 22*10**9      # Bulk modulus
    V1_0 = 0.3           # Volume of the chambre in the working cylinders 
    V2_0 = 0.1           # Volume of the chambre in the return cylinders 
    ...
    # Preassure parameters of the hydraulic press
    PS = 32*10**6                                   # Supply preassure [Pa]
    PT = 101325                                     # Return preassure [Pa] (1 atm)

    # Geometric parameters
    MU = 0.3            # Coefficient of friction stress
    K  = 1.115          # Deformation strenghthening indicator
    W0 = 0.2            # Original width [m]
    H0 = 0.5            # Original height [m]
    B0 = 0.1            # Original bite lenght [m]
    ...
    T = 900                                         # Deformation temperatuire [K]     
    ...
    p1    = model.set_variable('_x', 'p1')          # Preassure in the working cylinder 
    p2    = model.set_variable('_x', 'p2')          # Preassure in the return cylinder  
    ...
    model.set_rhs('y_dot', (3*np.pi*D1**2*p1/4 - np.pi*D2**2*p2/2 - B*y_dot - Ft - Fd_article)/M + G, process_noise=True)
